...
class ConfigManager:
    ...
    def save_settings(self):
        ...
        try:
            ...
            # Refresh hotkey labels in assist panel
            assist_panel = self.gui_elements.get('assist_panel')
            if assist_panel and hasattr(assist_panel, 'refresh_hotkey_labels'):
                assist_panel.refresh_hotkey_labels()
