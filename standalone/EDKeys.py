...
from PyQt5.QtWidgets import (
    QApplication, QMainWindow, QPushButton, QWidget, QGridLayout, QVBoxLayout,
    QHBoxLayout, QSizePolicy, QLabel, QTextEdit, QAction, QFileDialog,
    QTabWidget, QMessageBox, QDialog, QScrollArea, QGroupBox, QListWidget,
    QDialogButtonBox, QListWidgetItem, QRadioButton, QCheckBox, QLineEdit,
    QComboBox
)
from PyQt5.QtCore import Qt, QTimer, QEvent, QMetaObject, pyqtSignal, QObject, pyqtSlot, Q_ARG

# pynput for global key logging
from pynput import keyboard

# Own modules
from logging_setup import LogBuffer, QTextEditLogger, setup_logging
...
class KeyboardGUI(QMainWindow):  # Main GUI window
    ...
    def get_ignored_keys(
        ...
        return {
            ...
            # The keys below are being handled separately, as there's no good way natively to deal with them.
