...
import sys
import os
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QWidget, QGridLayout, QVBoxLayout, QHBoxLayout
...
class EDKeys:
    ...
    def get_scancode_for_key(self, key):
        normalized_key = self.normalize_key(key)
        return SCANCODE.get(f'DIK_{normalized_key.upper()}')
